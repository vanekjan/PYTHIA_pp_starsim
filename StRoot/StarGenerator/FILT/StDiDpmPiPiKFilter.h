#ifndef StDiDpmPiPiKFilter_h
#define StDiDpmPiPiKFilter_h
...
class StDiDpmPiPiKFilter : public StarFilterMaker
{
public:
  StDiDpmPiPiKFilter(  );
  virtual ~StDiDpmPiPiKFilter();
